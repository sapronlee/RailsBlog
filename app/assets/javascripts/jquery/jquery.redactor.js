	...
	this.opts = $.extend({
		...
		modal_image_edit: String() + 
			'<div class="modal-body">' +
				...
				'<input id="redactor_file_alt" class="span5" type="text" />' +
				'<label>' + RLANG.link + '</label>' +
				'<input id="redactor_file_link" class="span5" type="text" />' +
			...
			'<div class="modal-footer">' +
				'<a href="javascript:void(null);" id="redactor_image_delete_btn" class="btn pull-left">' + RLANG._delete + '</a>' +
				'<input type="button" name="save" id="redactorSaveBtn" class="btn btn-primary" value="' + RLANG.save + '" />' +
		...
		modal_link: String() + 
			'<div class="modal-body">' +
				'<form id="redactorInsertLinkForm" method="post" action="">' +
					'<ul id="redactor_tabs" class="nav nav-tabs">' +
						'<li class="active"><a href="#redactor_tab1" class="redactor_tabs_act" data-toggle="tab">URL</a></li>' +
						'<li><a href="#redactor_tab2" data-toggle="tab">Email</a></li>' +
						'<li><a href="#redactor_tab3" data-toggle="tab">' + RLANG.anchor + '</a></li>' +
					'</ul>' +
					'<input type="hidden" id="redactor_tab_selected" value="1" />' +
					'<div class="redactor_tab active" id="redactor_tab1">' +
						'<label>URL</label><input id="redactor_link_url" class="redactor_input span5" type="text" />' +
						'<label>' + RLANG.text + '</label><input class="redactor_input redactor_link_text span5" type="text" id="redactor_link_url_text" />' +
					'</div>' +
					'<div class="redactor_tab" id="redactor_tab2" style="display: none;">' +
						'<label>Email</label><input id="redactor_link_mailto" class="redactor_input span5" type="text" />' +
						'<label>' + RLANG.text + '</label><input class="redactor_input redactor_link_text span5" type="text" id="redactor_link_mailto_text" />' +
					'</div>' +
					'<div class="redactor_tab" id="redactor_tab3" style="display: none;">' +
						'<label>' + RLANG.anchor + '</label><input class="redactor_input span5" id="redactor_link_anchor" type="text"  />' +
						'<label>' + RLANG.text + '</label><input class="redactor_input redactor_link_text span5" type="text" id="redactor_link_anchor_text" />' +
					'</div>' +
				'</form>' +
			'</div>' +
			'<div class="modal-footer">' +
					'<a href="javascript:void(null);" id="redactor_btn_modal_close" class="btn">' + RLANG.cancel + '</a>' +
					'<input type="button" id="redactor_insert_link_btn" class="btn btn-primary" value="' + RLANG.insert + '" />' +
			'</div>',
		
		modal_table: String() + 
			'<div class="modal-body">' +
				'<label>' + RLANG.rows + '</label>' +
				'<input value="2" id="redactor_table_rows" class="span5" type="text" />' +
				'<label>' + RLANG.columns + '</label>' +
				'<input value="3" id="redactor_table_columns" class="span5" type="text" />' +
			'</div>' +
			'<div class="modal-footer">' +
					'<a href="javascript:void(null);" id="redactor_btn_modal_close" class="btn">' + RLANG.cancel + '</a>' +
					'<input type="button" name="upload" id="redactor_insert_table_btn" class="btn btn-primary" value="' + RLANG.insert + '" />' +
			'</div>',
		...
		modal_video: String() + 
			...
			'<div class="modal-footer">' +
					'<a href="javascript:void(null);" id="redactor_btn_modal_close" class="btn">' + RLANG.cancel + '</a>' +
					'<input type="button" id="redactor_insert_video_btn" class="btn btn-primary" value="' + RLANG.insert + '" />' +
			'</div>',
...
Redactor.prototype = {
	...
	// MODAL
	// ChuckLee edit 2012/8/15
	modalInit: function(title, url, width, handler, endCallback, scroll)
	{
		if ($('#redactor_modal').size() === 0)
		{
			this.modal = $(
				'<div id="redactor_modal" class="modal hide fade in">' +
		...
		$("#redactor_modal").on("hide", $.proxy(this.cleanModalCentent, this));

		$('#redactor_modal .modal-body').replaceWith(this.opts['modal_' + url]);
		$('#redactor_modal .modal-header h3').html(title);
	...
	cleanModalCentent: function()
	{
		$("#redactor_modal")
		.find(".modal-header h3").html("")
		.end()
